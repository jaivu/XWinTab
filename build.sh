...
winegcc -o XWinTabHelper.dll.so -shared -O2 src/XWinTabHelper.c src/XWinTabHelper.dll.spec -lxcb -lxcb-xinput
...
x86_64-w64-mingw32-gcc -shared -O2 -o wintab32.dll src/WinTab.c
